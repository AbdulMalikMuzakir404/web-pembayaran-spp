                ...
                <form action="{{ route('loginSiswaProses') }}" method="post">
                    ...
                    <div class="px-2">
                        <div class="form-group">
                            <label for="nisn"><i class="bi bi-person"></i></label>
                            <input type="text" class="@error('nisn') is-invalid @enderror" id="nisn"
                                name="nisn" value="{{ old('nisn') }}" placeholder="NISN" required
