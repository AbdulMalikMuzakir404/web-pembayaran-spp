...
<head>
    ...
    <title>SPP | INDEX</title>
    {{-- icon web app --}}
    <link rel="shortcut icon" href="{{ asset('storage/images/logo_aplikasi.png') }}">
    <link rel="stylesheet" href="{{ asset('index/nicepage.css') }}" media="screen">
    <link rel="stylesheet" href="{{ asset('index/Page-2.css') }}" media="screen">
    <script class="u-script" type="text/javascript" src="{{ asset('index/jquery.js') }}" defer=""></script>
    <script class="u-script" type="text/javascript" src="{{ asset('index/nicepage.js') }}" defer=""></script>
    ...
    <meta property="og:title" content="SPP | INDEX">
    <meta property="og:type" content="website">
</head>

<body data-home-page="undefined" data-home-page-title="Page 2" class="u-body u-xl-mode" data-lang="en">
                    ...
                    <div class="u-layout-row">
                        <div
                            ...
                            <div class="u-container-layout u-valign-middle u-container-layout-1">
                                <h1 class="u-custom-font u-text u-text-body-alt-color u-text-1">Aplikasi Pembayaran SPP
                                    Berbasis WEB</h1>
                                <p class="u-text u-text-body-alt-color u-text-2">Ut enim ad minim veniam, quis nostrud
                                    exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute
                                    irure dolor in reprehenderit in voluptate velit esse cillum </p>
                                <a href="{{ route('login') }}"
                                    class="u-active-palette-4-base u-btn u-btn-round u-button-style u-custom-font u-font-raleway u-hover-palette-4-base u-palette-1-base u-radius-50 u-text-body-alt-color u-btn-1">Login
                                    NOW</a>
                            </div>
                        </div>
    ...
    <section class="u-align-center u-clearfix u-white u-section-2" id="carousel_7a94">
        <div class="u-clearfix u-sheet u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
            <h1 class="u-align-center u-text u-text-1">My Features</h1>
            ...
            <img alt=""
                ...
                src="{{ asset('index/images/fffffff-min.jpg') }}" data-image-width="1200" data-image-height="800">
                    ...
                    <div
                        ...
                        <div class="u-container-layout u-similar-container u-valign-middle u-container-layout-1"><span
                                class="u-icon u-icon-1"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice"
                                    ...
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-2ea6"></use>
                                </svg><svg class="u-svg-content" viewBox="0 0 512 512" id="svg-2ea6">
                                    <g>
                                        <path
                            ...
                            <h4 class="u-align-center u-text u-text-3">Bayar SPP</h4>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="u-container-layout u-similar-container u-valign-middle u-container-layout-2"><span
                                class="u-icon u-icon-2"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice"
                                    viewBox="0 0 128 128" style="">
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-be8d"></use>
                                </svg><svg class="u-svg-content" viewBox="0 0 128 128" id="svg-be8d">
                                    <path
                            ...
                            <h4 class="u-align-center u-text u-text-4">History Pembayaran</h4>
                        </div>
                    </div>
                    <div
                        class="u-align-center u-container-style u-custom-item u-list-item u-palette-3-base u-repeater-item u-shape-rectangle">
                        <div class="u-container-layout u-similar-container u-valign-middle u-container-layout-3"><span
                                class="u-icon u-icon-3"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice"
                                    viewBox="0 0 128 128" style="">
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-7049"></use>
                                </svg><svg class="u-svg-content" viewBox="0 0 128 128" id="svg-7049">
                                    <path
                            ...
                            <h4 class="u-align-center u-text u-text-5">Create Data Laporan</h4>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="u-container-layout u-similar-container u-valign-middle u-container-layout-4"><span
                                class="u-icon u-icon-4"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice"
                                    viewBox="0 0 128 128" style="">
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-f6ba"></use>
                                </svg><svg class="u-svg-content" viewBox="0 0 128 128" id="svg-f6ba">
                                    <path
    ...
    <section class="u-align-center u-clearfix u-section-3" id="sec-6cb1">
        <div
            class="u-clearfix u-sheet u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-valign-top-lg u-valign-top-xl u-sheet-1">
            <div class="u-expanded-width u-list u-list-1">
                <div class="u-repeater u-repeater-1">
                    <div class="u-align-center u-container-style u-list-item u-repeater-item">
                        <div class="u-container-layout u-similar-container u-valign-middle u-container-layout-1">
                            <h1 class="u-text u-title u-text-1" data-animation-name="counter"
                                data-animation-event="scroll" data-animation-duration="3000" style="font-size: 50px;">92</h1>
                            <p class="u-text u-text-2">Lorem ipsum dolor sit amet</p>
                        </div>
                    </div>
                    <div class="u-align-center u-container-style u-list-item u-repeater-item">
                        <div class="u-container-layout u-similar-container u-valign-middle u-container-layout-2">
                            <h1 class="u-text u-title u-text-3" data-animation-name="counter"
                                data-animation-event="scroll" data-animation-duration="3000" style="font-size: 50px;">25</h1>
                            <p class="u-text u-text-4">Lorem ipsum dolor sit amet</p>
                        </div>
                    </div>
                    <div class="u-align-center u-container-style u-list-item u-repeater-item">
                        <div class="u-container-layout u-similar-container u-valign-middle u-container-layout-3">
                            <h1 class="u-text u-title u-text-5" data-animation-name="counter"
                                data-animation-event="scroll" data-animation-duration="3000" style="font-size: 50px;">37</h1>
                            <p class="u-text u-text-6">Lorem ipsum dolor sit amet</p>
                        </div>
                    </div>
                    <div class="u-align-center u-container-style u-list-item u-repeater-item">
                        <div class="u-container-layout u-similar-container u-valign-middle u-container-layout-4">
                            <h1 class="u-text u-title u-text-7" data-animation-name="counter"
                                data-animation-event="scroll" data-animation-duration="3000" style="font-size: 50px;">87</h1>
                            <p class="u-text u-text-8">Lorem ipsum dolor sit amet</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="u-align-center-xs u-clearfix u-section-4" src="" id="carousel_e520">
        <div
            ...
            <img class="u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-image u-image-contain u-image-1"
                src="{{ asset('index/images/ffff.jpg') }}" data-image-width="1200" data-image-height="800">
            <div
                ...
                <div class="u-container-layout u-valign-middle u-container-layout-1">
                    ...
                    <p class="u-large-text u-text u-text-variant u-text-2">We collaborate with you to create new value
                        through digital transformation. We have hundreds of specialists at your service. </p>
                    <a href="https://nicepage.com/website-builder"
                        class="u-active-palette-4-base u-border-0 u-btn u-btn-round u-button-style u-custom-font u-font-raleway u-hover-palette-4-base u-palette-1-base u-radius-50 u-text-body-alt-color u-btn-1">learn
                        more</a>
                </div>
            </div>
        </div>
    ...
    <section class="u-align-center u-clearfix u-palette-2-base u-section-5" id="carousel_7a8d">
        <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
            ...
            <p class="u-text u-text-2">We align leaders around a shared purpose and strategic story that catalyzes
                their business and brand to take action.</p>
                            ...
                            <div class="u-layout-row">
                                <div
                                    ...
                                    <div class="u-container-layout u-valign-top u-container-layout-1"><span
                                        ...
                                        <p class="u-text u-text-4">Jln Ceuri Jln Terusan Kopo No. KM 13.5, Katapang, Kec.Katapang, Kab.Bandung JAWA BARAT 40971
                                        </p>
                                    </div>
                                </div>
                                <div class="u-container-style u-layout-cell u-size-20 u-white u-layout-cell-2">
                                    <div class="u-container-layout u-valign-top u-container-layout-2"><span
                                            class="u-border-3 u-border-grey-15 u-icon u-icon-circle u-spacing-20 u-text-grey-40 u-icon-2"><svg
                                                class="u-svg-link" preserveAspectRatio="xMidYMin slice"
                                                viewBox="0 0 479.058 479.058" style="">
                                                <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                                    xlink:href="#svg-89cb"></use>
                                            </svg><svg class="u-svg-content" viewBox="0 0 479.058 479.058"
                                                id="svg-89cb">
                                                <path
                                        ...
                                        <a href="mailto:ridwanhambali66@smk.belajar.id"
                                            class="u-border-active-none u-border-hover-none u-btn u-btn-rectangle u-button-style u-none u-text-body-color u-text-hover-palette-2-base u-btn-1">SMKN1katapang91@gmail.com</a>
                                        <a href="https://nicepage.com/k/arabic-style-html-templates"
                                            class="u-border-active-none u-border-hover-none u-btn u-btn-rectangle u-button-style u-none u-text-body-color u-text-hover-palette-2-base u-btn-2">SMKN1katapangSupport@gmail.com</a>
                                    </div>
                                </div>
                                <div
                                    ...
                                    <div class="u-container-layout u-valign-top u-container-layout-3"><span
                                            class="u-border-3 u-border-grey-15 u-icon u-icon-circle u-spacing-20 u-text-grey-40 u-icon-3"><svg
                                                class="u-svg-link" preserveAspectRatio="xMidYMin slice"
                                                viewBox="0 0 384 384" style="">
                                                <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                                    xlink:href="#svg-6093"></use>
                                            </svg><svg class="u-svg-content" viewBox="0 0 384 384" x="0px"
                                                y="0px" id="svg-6093"
                                        ...
                                        <p class="u-text u-text-7"><a style="color: #000;" href="tel://085727721692">+62 887-3243-1232</a> <br>+62 887-1234-1231
                                        </p>
                                    </div>
                                </div>
                            </div>
    ...
    <footer class="u-clearfix u-footer u-grey-80" id="sec-f537">
        <div class="u-clearfix u-sheet u-sheet-1">
            <div class="u-clearfix u-expanded-width u-gutter-30 u-layout-wrap u-layout-wrap-1">
                <div class="u-gutter-0 u-layout">
                    <div class="u-layout-row">
                        <div
                            class="u-align-center-sm u-align-center-xs u-layout-cell u-left-cell u-similar-fill u-size-15 u-size-30-md u-layout-cell-1">
                            <div class="u-container-layout u-valign-top u-container-layout-1">
                                <p class="u-align-left-lg u-align-left-md u-small-text u-text u-text-1">Created by Rekayasa Perangkat Lunak 1</p>
                            </div>
                        </div>
                        <div
                            class="u-align-center-sm u-align-center-xs u-layout-cell u-similar-fill u-size-15 u-size-30-md u-layout-cell-2">
                            <div class="u-container-layout u-valign-top u-container-layout-2">
                                <p class="u-align-left-lg u-align-left-md u-small-text u-text u-text-2">Compyrigt SMKN 1 KATAPANG</p>
                            </div>
                        </div>
                        <div
                            class="u-align-center-sm u-align-center-xs u-layout-cell u-similar-fill u-size-15 u-size-30-md u-layout-cell-3">
                            <div class="u-container-layout u-valign-top u-container-layout-3">
                                <p class="u-align-left-lg u-align-left-md u-small-text u-text u-text-3">Web dilindungi UUD</p>
                            </div>
                        </div>
                        <div
                            class="u-align-center-sm u-layout-cell u-right-cell u-similar-fill u-size-15 u-size-30-md u-layout-cell-4">
                            <div class="u-container-layout u-valign-top u-container-layout-4">
                                <img src="{{ asset('storage/images/logo_aplikasi.png') }}"
                                    alt=""
                                    class="u-align-left u-image u-image-contain u-image-default u-image-1"
        ...
        class="u-back-to-top u-file-icon u-icon u-icon-circle u-opacity u-opacity-85 u-palette-1-base u-spacing-15"
        data-href="#"><img src="{{ asset('index/images/6469473.png') }}" alt=""></span>
