...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="{{ asset("storage/images/logo_aplikasi.png") }}" alt="Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
            ...
            @if (Auth::user()->image != null)
            <img src="{{ asset('storage/profile/' . Auth::user()->image) }}" alt="img" class="rounded-circle" height="150px"
                    width="150" id="myImg">
            @endif
        </div>
        <div class="info">
